...
- Function _generate_graph()_: use the previous generated center node to generate the graph by connecting to the instances of class _Movie_ created using the data stored in the database
